...
public class UpdateCategoryScreen extends javax.swing.JPanel implements UpdateCategoryViewController {

    private final UpdateCategoryViewModel viewModel;
    ...
    public UpdateCategoryScreen(Category category) {
        viewModel = CategoryModule.getInstance().provideUpdateCategoryViewModel();
    ...
    private void initComponents() {
        ...
        lblHadline.setText("Editar Categoria");
    ...
    private void update() {
        ...
        response.accept(new ResponseVisitor<>() {
            ...
            public void visitSuccess(Response.Success<Category> success) {
                viewModel.onEvent(new CategoryEvent.UpdateCategoryEvent(success.getObject()));
            }
    ...
    private class Screen {
        ...
        public void assembleComponents() {
            ...
            txtPercentageProfit.setText(Percentage.format(category.getIncrease()));
    ...
    private class Form {
        ...
        public Response<Category> isValid() {
            ...
            try {
                ...
                category.setIncrease(percentage);

                return new Response.Success<>(category);
