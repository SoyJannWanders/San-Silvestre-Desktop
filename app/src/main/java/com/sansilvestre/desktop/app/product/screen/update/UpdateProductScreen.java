...
public class UpdateProductScreen extends javax.swing.JPanel implements UpdateProductViewController {
    ...
    public UpdateProductScreen(Map<Integer, Category> categories, Product product) {
        viewModel = ProductModule.getInstance().provideUpdateProductViewModel();
    ...
    private void initComponents() {
        ...
        lblHeadline.setText("Editar Producto");
    ...
    private void setValues() {
        ...
        double totalTaxes = Setting.getInstance().getPercentageProfit() + categories.get(product.getCategoryId()).getIncrease() + taxes;
        lblEnteredTaxes.setText(Percentage.format(totalTaxes));

        double profit = spendPerUnit * (totalTaxes / 100);
    ...
    private void update() {
        ...
        response.accept(new ResponseVisitor<>() {
            ...
            public void visitSuccess(Response.Success<Product> success) {
                viewModel.onEvent(new ProductEvent.UpdateProductEvent(success.getObject()));
            }
    ...
    private class Screen {
        ...
        public void assembleComponents() {
            ...
            cmbCategory.setSelectedItem(categories.get(product.getCategoryId()));

            Styles.setStyleTo(lblSpent, "label.small");

            Placeholder.setPlaceholderTo(txtSpent, "$ 0");
            txtSpent.setText(Currency.format(product.getSpent()));

            Styles.setStyleTo(lblUnit, "label.small");

            spnUnit.setValue(product.getUnits());

            Styles.setStyleTo(lblStock, "label.small");

            spnStock.setValue(product.getStock());

            Styles.setStyleTo(lblTaxes, "label.small");

            Placeholder.setPlaceholderTo(txtTaxes, "0%");
            txtTaxes.setText(Percentage.format(product.getTaxes()));
        ...
        public void initializeListeners() {
            ...
            txtTaxes.addKeyListener(new KeyAdapter() {
                ...
                public void keyPressed(KeyEvent e) {
                    ...
                    txtTaxes.setText(Percentage.removeFormat(in));
                }
