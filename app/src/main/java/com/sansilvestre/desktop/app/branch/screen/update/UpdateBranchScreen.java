...
public class UpdateBranchScreen extends javax.swing.JPanel implements UpdateBranchViewController {

    private final UpdateBranchViewModel viewModel;
    ...
    public UpdateBranchScreen(Branch branch) {
        viewModel = BranchModule.getInstance().provideUpdateBranchViewModel();
        this.branch = branch;
        initComponents();
        setup();
    }
    ...
    private void initComponents() {
        ...
        lblHeadline.setText("Editar Sucursal");
    ...
    private void update() {
        ...
        response.accept(new ResponseVisitor<>() {
            ...
            public void visitSuccess(Response.Success<Branch> success) {
                viewModel.onEvent(new BranchEvent.UpdateBranchEvent(success.getObject()));
            }
    ...
    private class Form {
        ...
        public Response<Branch> isValid() {
            ...
            try {
                ...
                return new Response.Success<>(branch);
