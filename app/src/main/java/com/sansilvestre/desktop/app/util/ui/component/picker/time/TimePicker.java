package com.sansilvestre.desktop.app.util.ui.component.picker.time;

import com.formdev.flatlaf.FlatClientProperties;
import com.formdev.flatlaf.extras.FlatSVGIcon;
import com.sansilvestre.desktop.app.util.ui.component.picker.util.InputUtils;
import com.sansilvestre.desktop.app.util.ui.component.picker.util.Utils;
...
public class TimePicker extends JPanel {
    ...
    private void installEditor(JFormattedTextField editor) {
        ...
        editorButton = new JButton(editorIcon != null ? editorIcon : new FlatSVGIcon("drawable/icon/schedule.svg", 0.69f));
